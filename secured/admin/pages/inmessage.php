...
if(isset($_POST['news'])){
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1><i class="fa fa-user " style="font-size:30px"></i> ANNOUNCEMENT MANAGEMENT</h1>
 ...
 <div class="form-group">
	  ...
	  <button style="" type="submit" class="btn btn-primary" name="news" > <i class="fa fa-send"></i>&nbsp; Add Announcemnet </button>
