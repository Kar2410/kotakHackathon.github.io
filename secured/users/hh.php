...
function googleTranslateElementInit() {
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
                ...
                <a href="home.php" class="nav-link "><i class="fas fa-home"></i><span>My Account</span></a>
                 </li>
 ...
 <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-users"></i> <span>All Features</span></a>
