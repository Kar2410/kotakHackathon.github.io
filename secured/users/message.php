                                            ...
                                            <?php if($msg != "") echo "<div style='padding:20px;background-color:#dce8f7;color:black'> $msg</div class='btn btn-success'>" ."</br></br>";  ?>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
    <textarea  name="message" placeholder="Type enter your message"  class="form-control" style="width: 700px; margin-left: -295px;">
</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <input type="submit" name="msgs" value="Send Message"  class="btn btn-info" / style="margin-left: 450px; margin-top:-40px;">
                                                        </div>
                                                    </div>
                                                </div>
...
<table id="table" class="table table-responsive table-striped table-bordered table-hover" style="margin-top:30px;" >
