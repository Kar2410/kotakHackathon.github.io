...
$rtn = $link->real_escape_string($_POST['rtn']);
...
$sql1 = "INSERT INTO tbl_users (fname, lname, pwd, email, phone, gender, is_mobile, mobile_hash, utype, pics, bdate,acctno,active,status,pin,session,balance,address,city,state,zipcode,notification,nbalance,inbalance,bname,country,ipn,imf,cot,ssn,rtn)
VALUES ('$fname', '$lname', '$pwd', '$email', '$phone', '$gender', '$is_mobile','$mobile_hash', '$utype', '$image', '$bdate','$account','$active','$status','$pin','$session','$balance','$address','$city','$state','$zipcode','$notification','$nbalance','$inbalance','$bname','$country','$ipn','$imf','$cot','$ssn','$rtn')";
                                        ...
                                        <div class="tab-pane" id="address">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>SSN</label>
                                                        <input required name="ssn" type="text" class="form-control" placeholder="SSN">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input required name="rtn" type="text" class="form-control" placeholder="Routing Number">
                                                    </div>
                                                </div>
